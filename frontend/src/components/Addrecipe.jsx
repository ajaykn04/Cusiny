    ...
    if (validateFields()) {
      ...
      if (toeditrecipe.state != null) {
        try {
          ...
          await axios.put("https://cusinybackend-1werqhmxi-ajay-das-projects-8d492c1c.vercel.app/recipe/edit/", formData);
        ...
        try {
          ...
          await axios.post(`https://cusinybackend-1werqhmxi-ajay-das-projects-8d492c1c.vercel.app/recipe/add/`, formData);
          navigate("/user/recipes");
        } catch (error) {
          console.error(error);
        }
