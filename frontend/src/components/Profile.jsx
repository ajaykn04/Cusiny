  ...
  const submitHandler = async () => {
    if (validateFields()) {
      try {
        ...
        await axios.put(`https://cusinybackend-git-sqlhost-ajay-das-projects-8d492c1c.vercel.app/user/edit/`, updatedProfile);
      ...
      >
        <Box mt={"4.5vh"} sx={styles.box_style}>
          ...
          <Button
            ...
            sx={{ mt: 2 }}
            onClick={async () => {
              await axios.delete(`https://cusinybackend-git-sqlhost-ajay-das-projects-8d492c1c.vercel.app/user/delete/`, {
                data: data,
              });
              navigate("/");
              localStorage.removeItem("userData");
