...
const Myrecipe = () => {
  ...
  useEffect(() => {
    if (data._id) {
      const apiUrl = `https://cusinybackend-g3y3f0at0-ajay-das-projects-8d492c1c.vercel.app/user/recipes/${data._id}`;
      axios
        .get(apiUrl)
        .then((response) => {
  ...
  const handleDelete = async (recipeId) => {
    try {
      await axios.delete(`https://cusinybackend-g3y3f0at0-ajay-das-projects-8d492c1c.vercel.app/recipe/delete/${recipeId}`);
