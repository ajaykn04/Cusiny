            ...
            <AppBar position='fixed'>
                <StyledToolbar>
                    ...
                    <Container sx={{ display: 'flex', justifyContent: 'flex-start', gap: '6rem' }}>
                        <Button variant='text' onClick={() => navigate('/userdash', { state: currentLocation.state })} style={{ fontSize: '20px', fontFamily: 'fantasy', color: 'black' }}>
                            <Typography style={{ fontFamily: 'fantasy', fontSize: '20px', color: 'orange' }}>HOME</Typography>
                        </Button>
                        <Button variant='text' onClick={() => navigate('/recipe/add', { state: currentLocation.state })} style={{ fontSize: '20px', fontFamily: 'fantasy', color: 'black' }}>
                            <Typography style={{ fontFamily: 'fantasy', fontSize: '20px', color: 'orange' }}>Add Recipe</Typography>
                        </Button>
                        <Button variant='text' onClick={() => navigate('/user/recipes', { state: currentLocation.state })} style={{ fontSize: '20px', fontFamily: 'fantasy', color: 'black' }}>
                            <Typography style={{ fontFamily: 'fantasy', fontSize: '20px', color: 'orange' }}>My Recipes</Typography>
                        </Button>
                        <Button variant='text' onClick={() => navigate('/recipes', { state: currentLocation.state })} style={{ fontSize: '20px', fontFamily: 'fantasy', color: 'black' }}>
